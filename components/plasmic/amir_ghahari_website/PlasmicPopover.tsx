...
import OverlayArrow from "../../OverlayArrow"; // plasmic-import: zr3odwUJdKbI/component
...
import sty from "./PlasmicPopover.module.css"; // plasmic-import: jXAPaBYI8VFR/css
  ...
  return (
    <BaseDialogTrigger
      ...
      dialog={
        ...
        >
          ...
          >
            {renderPlasmicSlot({
              defaultContents: (
                <div className={classNames(projectcss.all, sty.freeBox__mmzq9)}>
                  <div
                    className={classNames(
                      projectcss.all,
      ...
      trigger={renderPlasmicSlot({
        defaultContents: (
          <Button
            className={classNames("__wab_instance", sty.button__vUf1K)}
            label={"Open Popover"}
          />
        ),
