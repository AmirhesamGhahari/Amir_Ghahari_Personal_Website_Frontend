...
import Radio from "../../Radio"; // plasmic-import: yi7ZELzvAgiR/component
...
import sty from "./PlasmicRadioGroup.module.css"; // plasmic-import: -VHgXd9Ai__C/css
...
function PlasmicRadioGroup__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames(projectcss.all, sty.freeBox___7Xaui)}>
            <Radio
              className={classNames("__wab_instance", sty.radio__pTxO)}
              label={"Option 1"}
              value={"option1"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__xK1Ln)}
              label={"Option 2"}
              value={"option2"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__fBf44)}
              label={"Option 3"}
              value={"option3"}
            />
          </div>
