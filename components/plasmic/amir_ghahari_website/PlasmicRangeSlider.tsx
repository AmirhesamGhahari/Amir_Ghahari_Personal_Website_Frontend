...
import SliderThumb from "../../SliderThumb"; // plasmic-import: tYylMrP-rxCe/component
...
import sty from "./PlasmicRangeSlider.module.css"; // plasmic-import: klZqWvBYxnaj/css
...
function PlasmicRangeSlider__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__it8Xn)}>
        {$props.showLabel ? (
          <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox__pvVa)}>
        <div
