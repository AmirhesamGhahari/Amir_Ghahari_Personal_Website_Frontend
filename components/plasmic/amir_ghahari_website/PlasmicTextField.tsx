...
import Label from "../../Label"; // plasmic-import: NX5JuPa8tHpI/component
import TextInput from "../../TextInput"; // plasmic-import: hFyLC2BuGVE6/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: SKYkTiKa2gPu/component
import Description from "../../Description"; // plasmic-import: 1-9ZmljEJkG2/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: 5lGk1d8mbe5J/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__d34Vi, {
          [sty.freeBoxiconEnd__d34VilFtfZ]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__d34Via9Rz6]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__d34Vi1F5IW]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__wpPz1, {
            [sty.freeBoxiconStart__wpPz1A9Rz6]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__wpPz11F5IW]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__luXTf)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox___6Vu6I, {
            [sty.freeBoxiconEnd___6Vu6ILFtfZ]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart___6Vu6IA9Rz6]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg___3SPee)}
                role={"img"}
              />
            ),
