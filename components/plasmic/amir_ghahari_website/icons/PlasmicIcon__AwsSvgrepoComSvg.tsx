...
export type AwsSvgrepoComSvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function AwsSvgrepoComSvgIcon(props: AwsSvgrepoComSvgIconProps) {
  ...
  return (
    ...
    >
      ...
      <g fill={"#F90"} fillRule={"evenodd"} clipRule={"evenodd"}>
        <path
          d={
            "M14.465 11.813c-1.75 1.297-4.294 1.986-6.481 1.986-3.065 0-5.827-1.137-7.913-3.027-.165-.15-.016-.353.18-.235 2.257 1.313 5.04 2.109 7.92 2.109 1.941 0 4.075-.406 6.039-1.239.293-.133.543.192.255.406"
          }
        ></path>

        <path
          d={
            "M15.194 10.98c-.223-.287-1.479-.138-2.048-.069-.17.022-.197-.128-.043-.24 1-.705 2.645-.502 2.836-.267.192.24-.053 1.89-.99 2.68-.143.123-.281.06-.218-.1.213-.53.687-1.72.463-2.003z"
          }
        ></path>
      </g>
    </svg>
...
export default AwsSvgrepoComSvgIcon;
/* prettier-ignore-end */
