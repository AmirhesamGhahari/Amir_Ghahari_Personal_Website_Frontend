...
import sty from "./PlasmicButton.module.css"; // plasmic-import: eSLDweFKs_s3/css
...
function PlasmicButton__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__rW2S, {
          [sty.freeBoxcolor_neutral__rW2STp6QV]: hasVariant(
            $state,
            "color",
            "neutral"
          ),
          [sty.freeBoxcolor_success_type_bordered__rW2S9MVzTa9ON]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered"),
          [sty.freeBoxroundedFull__rW2S2RYsC]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge__rW2SZvSu]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall__rW2SRjljl]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large__rW2SfliR]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small__rW2SApHUm]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered__rW2Sta9ON]: hasVariant(
            $state,
            "type",
            "bordered"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__v2Ly, {
            [sty.freeBoxcolor_neutral__v2LyTp6QV]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxcolor_neutral_type_soft__v2LyTp6QVGv9NR]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft"),
            [sty.freeBoxiconStart__v2Lym5V9G]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge__v2LyZvSu]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__v2LyFliR]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__v2LyApHUm]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered__v2Lyta9ON]: hasVariant(
              $state,
              "type",
              "bordered"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__eehR1)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__mwGw2, {
            [sty.freeBoxiconEnd__mwGw2YhlM]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge__mwGw2ZvSu]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__mwGw2FliR]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__mwGw2ApHUm]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDownIcon
                className={classNames(projectcss.all, sty.svg__u9Fq8)}
                role={"img"}
              />
            ),
