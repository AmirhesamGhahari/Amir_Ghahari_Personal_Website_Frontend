...
import sty from "./PlasmicRadio.module.css"; // plasmic-import: yi7ZELzvAgiR/css
...
function PlasmicRadio__RenderFunc(props: {
  ...
  return (
    <BaseRadio
      ...
      value={args.value}
    >
      <div className={classNames(projectcss.all, sty.freeBox__ucirD)}>
        <div className={classNames(projectcss.all, sty.freeBox__jkcDj)} />
      </div>
      {renderPlasmicSlot({
