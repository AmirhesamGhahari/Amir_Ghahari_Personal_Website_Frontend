...
import sty from "./PlasmicCheckbox.module.css"; // plasmic-import: KTLk6kDb0yWs/css

import CheckIcon from "./icons/PlasmicIcon__Check"; // plasmic-import: Q5KZ7URfgO0_/icon
import MinusIcon from "./icons/PlasmicIcon__Minus"; // plasmic-import: bpb03zk2fz1N/icon
    ...
    >
      ...
      >
        {(
          ...
          <CheckIcon
            className={classNames(projectcss.all, sty.svg__fUogh)}
            role={"img"}
          />
        ) : null}
        {($ccVariants["indeterminate"] ? true : false) ? (
          <MinusIcon
            className={classNames(projectcss.all, sty.svg__tm8Oh)}
            role={"img"}
          />
        ) : null}
      </div>
