...
import Button from "../../Button"; // plasmic-import: eSLDweFKs_s3/component
...
import sty from "./PlasmicDrawer.module.css"; // plasmic-import: lXgYbIP1tMDO/css
    ...
    <BaseDialogTrigger
      ...
      dialog={
        <BaseModal
          ...
          modalOverlayClass={classNames({ [sty["pcls_wkbkz36i-vg-"]]: true })}
        ...
        >
          ...
          >
            <div className={classNames(projectcss.all, sty.freeBox__qjcJe)}>
              {renderPlasmicSlot({
                defaultContents: (
                  <h2
                    className={classNames(
              ...
              <div className={classNames(projectcss.all, sty.freeBox__cr3U1)}>
                {renderPlasmicSlot({
                  defaultContents: (
                    <div
                      className={classNames(projectcss.all, sty.freeBox__jJgIc)}
                    >
                      <Button
                        color={"muted"}
                        label={"Close"}
      ...
      trigger={
        (hasVariant($state, "noTrigger", "noTrigger") ? false : true)
          ? renderPlasmicSlot({
              defaultContents: (
                <Button
                  className={classNames("__wab_instance", sty.button__sDpI2)}
                  label={
                    <div
                      className={classNames(
                        projectcss.all,
