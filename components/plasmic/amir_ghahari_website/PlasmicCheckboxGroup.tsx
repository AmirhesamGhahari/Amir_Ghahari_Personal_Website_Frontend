...
import Checkbox from "../../Checkbox"; // plasmic-import: KTLk6kDb0yWs/component
...
import sty from "./PlasmicCheckboxGroup.module.css"; // plasmic-import: V8LiFwPXa5OL/css
...
function PlasmicCheckboxGroup__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames(projectcss.all, sty.freeBox__vhJvA)}>
            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__kTws)}
              label={"Option 1"}
              value={"option1"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__asuqa)}
              label={"Option 2"}
              value={"option2"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox___6U3Wj)}
              label={"Option 3"}
              value={"option3"}
            />
          </div>
