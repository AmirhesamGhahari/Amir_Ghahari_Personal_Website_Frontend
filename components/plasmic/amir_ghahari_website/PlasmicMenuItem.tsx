...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: HfejmHiLQjn1/css
...
function PlasmicMenuItem__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__rgw4)}>
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox__ok3Q)}>
            <div
              className={classNames(
                projectcss.all,
